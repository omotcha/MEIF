...
"""
import os
from configs.config import model_test_dir, ecifp_catboost, ecifp_lightgbm, casf_dir, data_dir, meif_data_dir
import pandas as pd
...
def predict_on_decoy(f_pro, f_dec, model):
    """
    for CASF docking power analysis
    :param f_pro: protein file, .pdb
    :param f_dec: decoys file, .mol2
    :param model: specific model generated by autogluon
    :return:
    """
    ecifp_helper = ECIFP()
...
if __name__ == '__main__':
    predictions = predict_on_decoy(
        os.path.join(casf_dir["core"], "1a30", "1a30_protein.pdb"),
        os.path.join(casf_dir["decoys"], "1a30_decoys.mol2"),
        ecifp_catboost
    )
    print(predictions)
