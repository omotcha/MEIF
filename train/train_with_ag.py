...
class ECIFP_Trainer:
    ...
    def __init__(self, distance_cutoff=6.0, tag=""):
        ...
        if tag is None or tag == "":
            ...
            self._ecifp_data = TabularDataset(os.path.join(meif_data_dir, "ECIFP_{}_{}.csv".format(distance_cutoff, tag)))
        self._distance_cutoff = distance_cutoff
...
class ECIF_Trainer:
    ...
    def __init__(self, distance_cutoff=6.0, tag=""):
        ...
        if tag is None or tag == "":
            ...
            self._ecif_data = TabularDataset(os.path.join(meif_data_dir, "ECIF_{}_{}.csv".format(distance_cutoff, tag)))
        self._distance_cutoff = distance_cutoff
